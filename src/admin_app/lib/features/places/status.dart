...
extension StayState on Stay {
  ...
  /// gets the real figure when the clock stops; this is the preview.
...
/// A rate as the screens print it: whole pounds, no trailing zeros
String rateText(double rate) => rate == rate.roundToDouble() ? rate.toStringAsFixed(0) : rate.toStringAsFixed(2);
