 ...
 */
export const simulateOnlinePaymentMutation = (options?: Partial<Options<SimulateOnlinePaymentData>>): UseMutationOptions<SimulateOnlinePaymentResponse, AxiosError<SimulateOnlinePaymentError>, Options<SimulateOnlinePaymentData>> => {
    const mutationOptions: UseMutationOptions<SimulateOnlinePaymentResponse, AxiosError<SimulateOnlinePaymentError>, Options<SimulateOnlinePaymentData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await simulateOnlinePayment({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Let a pending payment go, so its share is free again at once
 *
 * The guest who started it (signed in, or by X-Guest-Id), or the till. A payment the provider later reports paid is still paid.
 */
export const cancelOnlinePaymentMutation = (options?: Partial<Options<CancelOnlinePaymentData>>): UseMutationOptions<CancelOnlinePaymentResponse, AxiosError<CancelOnlinePaymentError>, Options<CancelOnlinePaymentData>> => {
    const mutationOptions: UseMutationOptions<CancelOnlinePaymentResponse, AxiosError<CancelOnlinePaymentError>, Options<CancelOnlinePaymentData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await cancelOnlinePayment({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
