...
const kdsUrl = import.meta.env.VITE_KDS_URL || window.location.origin

export const authority = `${keycloakUrl}/realms/${realm}`
export const clientId = 'kds-web'
...
export const oidcConfig: AuthProviderProps = {
  ...
  client_id: clientId,
  redirect_uri: `${kdsUrl}/auth/callback`,
  ...
  // SSO sessions, a wall-mounted screen rarely sees the login page.
