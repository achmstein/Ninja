// Web push (FCM) token plumbing, the same as client_web's. Degrades
// gracefully: returns null when the browser doesn't support push, permission
// is denied, or the Firebase web config isn't provided.
