// Generates the typed translation dictionary from the Flutter customer
// app's ARB files, so web and mobile share the exact same strings
...
const arbDir = join(here, '..', '..', 'client_app', 'lib', 'l10n')
...
const output = `// Auto-generated from client_app/lib/l10n/app_{en,ar}.arb by
