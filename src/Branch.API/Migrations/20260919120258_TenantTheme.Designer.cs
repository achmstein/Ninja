...
namespace Ninja.Branch.API.Migrations
{
    ...
    [Migration("20260919120258_TenantTheme")]
    partial class TenantTheme
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ninja.Branch.API.Model.Tenant", b =>
                {
                    ...
                    b.Property<int>("WordmarkHeight")
                        .HasColumnType("integer");

                    b.Property<long>("WordmarkVersion")
                        .HasColumnType("bigint");

                    b.Property<int>("WordmarkWidth")
                        .HasColumnType("integer");
