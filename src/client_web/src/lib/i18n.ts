...
const webExtras = {
  ...
  splitHowMany: { en: 'People splitting', ar: 'كام واحد هيقسم' },
  splitYouPayFor: { en: 'You pay for', ar: 'هتدفع عن' },
  splitPartsOf: { en: '{parts} of {of}', ar: '{parts} من {of}' },
  ...
  customAmountHint: { en: 'Up to {amount}', ar: 'لحد {amount}' },
  customAmountTooMuch: {
    en: "That's more than is left ({amount})",
    ar: 'ده أكتر من الباقي ({amount})',
  },
  yourShare: { en: 'Your share', ar: 'نصيبك' },
  onlinePaymentFee: { en: 'Online payment fee', ar: 'رسوم الدفع أونلاين' },
  tip: { en: 'Tip', ar: 'بقشيش' },
  noTip: { en: 'No tip', ar: 'من غير' },
  addTip: { en: 'Add a tip', ar: 'تحب تسيب بقشيش؟' },
  ...
  payApplePay: { en: 'Apple Pay', ar: 'Apple Pay' },
  paySecureNote: {
