...
public static class AIServiceExtensions
{
    ...
    public static IHostApplicationBuilder AddAIServices(this IHostApplicationBuilder builder)
    {
        ...
        services.AddSingleton<IChillaxAgentFactory, ChillaxAgentFactory>();
        services.AddChillaxAIRateLimiting(options.RequestsPerMinute, options.PerUserRequestsPerMinute);
