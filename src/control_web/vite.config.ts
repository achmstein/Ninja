...
export default defineConfig({
  ...
  server: {
    // admin_web owns 5173, client_web 5174, pos_web 5175, kds_web 5176; the
    // control panel gets 5177 (the Keycloak control-web client's dev
    // redirect URI is pinned to this port).
    port: 5177,
    strictPort: true,
