 ...
 * com.ninja.kds/.KdsDeviceAdminReceiver` on a freshly reset device), the
...
class MainActivity : FlutterActivity() {
    private val channelName = "com.ninja.kds/kiosk"

    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        super.configureFlutterEngine(flutterEngine)
        // Updates from the platform's download page (see AppUpdater)
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.ninja.kds/update").setMethodCallHandler(AppUpdater(this))
