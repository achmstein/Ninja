...
/// <summary>
/// The eight switches as they stand after the brand or the plan changed:
...
public record TenantFeaturesChangedIntegrationEvent(
    ...
    bool Finance,
    bool Payroll,
    bool Kds) : IntegrationEvent
{
    public static TenantFeaturesChangedIntegrationEvent From(TenantFeatures f)
        => new(f.Reservations, f.TimeBilling, f.Loyalty, f.Tabs, f.Inventory, f.Finance, f.Payroll, f.Kds);
}
