...
/// shift status on the end side. Language, theme and sign-out are a
/// shift's worth of taps apart in practice, so they live behind the
/// settings menu instead of spending header width all day. All targets
/// ≥ 48 dp for gloved, hurried fingers — menu rows included.
...
class _PosHeaderState extends ConsumerState<PosHeader> with SingleTickerProviderStateMixin {
