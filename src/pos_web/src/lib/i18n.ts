...
const dictionary = {
  ...
  searchCustomersPlaceholder: { en: "Name, phone, or email", ar: "الاسم أو الجوال أو البريد الإلكتروني" },
  ...
  newCustomerPhone: { en: "Phone", ar: "رقم الجوال" },
  ...
  appLinkHint: { en: "They scan it with their phone camera to set an email and password. It works once.", ar: "يمسحه بكاميرا جواله ليضيف بريدًا إلكترونيًا وكلمة مرور. يعمل مرة واحدة فقط." },
