...
/// </summary>
public sealed class ChillaxAgentFactory(
    IOptions<AIOptions> options,
    ILoggerFactory loggerFactory,
    IServiceProvider services,
    IChatClient? chatClient = null) : IChillaxAgentFactory
{
    public bool IsEnabled => chatClient is not null;

    public ChillaxAgent Create(AgentDefinition definition)
    {
        ...
        var chatOptions = new ChatOptions
        {
            ...
            AdditionalProperties = new AdditionalPropertiesDictionary { [ChillaxAgent.AgentKeyProperty] = definition.Key },
        };
        ...
        return new ChillaxAgent(definition, agent, o, loggerFactory.CreateLogger<ChillaxAgent>());
    }
}
