...
export const getPlatformUpdatesQueryKey = (options?: Options<GetPlatformUpdatesData>) => createQueryKey('getPlatformUpdates', options);
 ...
 */
export const getPlatformUpdatesOptions = (options?: Options<GetPlatformUpdatesData>) => queryOptions<GetPlatformUpdatesResponse, AxiosError<DefaultError>, GetPlatformUpdatesResponse, ReturnType<typeof getPlatformUpdatesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPlatformUpdates({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPlatformUpdatesQueryKey(options)
});
