...
const webExtras = {
  ...
  addSeat: { en: 'Add a seat', ar: 'زوّد كرسي' },
  removeSeat: { en: 'Remove a seat', ar: 'شيل كرسي' },
  perPerson: { en: 'per person', ar: 'للفرد' },
  seatYou: { en: 'You', ar: 'انت' },
  seatFree: { en: 'Seat {n}', ar: 'كرسي {n}' },
  seatYours: { en: 'Seat {n}, you pay for it', ar: 'كرسي {n}، هتدفع عنه' },
  seatPaid: { en: 'Already paid', ar: 'اتدفع' },
  seatsHint: {
    en: "Tap the seats you're paying for. Paid seats are an estimate.",
    ar: 'دوس على الكراسي اللي هتدفع عنها. الكراسي المدفوعة تقديرية.',
  },
  ...
  // The Counter template (components/counter)
  counterWholeMenu: { en: 'Whole menu', ar: 'المنيو كله' },
  counterAddNote: { en: 'Add a note', ar: 'ضيف ملاحظة' },
  counterLess: { en: 'One less', ar: 'واحد أقل' },
  counterMore: { en: 'One more', ar: 'واحد كمان' },
  counterRemove: { en: 'Remove', ar: 'شيله' },
  counterHoldToOrder: { en: 'Hold to order', ar: 'دوس مطوّل واطلب' },
  counterOrderSent: { en: 'Order sent', ar: 'الطلب اتبعت' },
  counterOrderSentNote: { en: "We'll follow it on your bill", ar: 'هتلاقيه على حسابك' },
  counterSeeBill: { en: 'See bill', ar: 'الحساب' },
  counterEmptyTray: { en: 'Tap a dish to open it. Hold one to add it.', ar: 'دوس على صنف تفتحه، ودوس مطوّل تضيفه.' },
  counterYourOrder: { en: 'Your order', ar: 'طلبك' },
  counterMoreAtCheckout: { en: 'Note, promo or points', ar: 'ملاحظة أو كود أو نقط' },
  counterAdded: { en: '{name} added', ar: 'اتضاف {name}' },
  counterHintHoldAdd: { en: 'Hold to add', ar: 'دوس مطوّل تضيف' },
  counterHintTray: { en: 'Drag up to see your order', ar: 'اسحب لفوق تشوف طلبك' },
  counterHintSwipe: { en: 'Swipe up for more, sideways for other categories', ar: 'اسحب لفوق للمزيد، وللجنب لباقي الأقسام' },
  counterHintZoom: { en: 'Pinch or tap the grid to see everything', ar: 'اقرص أو دوس على المربعات تشوف كل حاجة' },
  counterKeepHolding: { en: 'Keep holding until the ring closes', ar: 'فضل دايس لحد ما الدايرة تقفل' },
  counterRemoved: { en: '{name} removed', ar: 'اتشال {name}' },
  counterUndo: { en: 'Undo', ar: 'رجّعه' },
  counterSoldOut: { en: '{name} is sold out right now', ar: '{name} خلص دلوقتي' },
