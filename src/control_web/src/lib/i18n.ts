...
const dictionary = {
  ...
  themeDevice: { en: 'Follow the device', ar: 'حسب الجهاز' },
  businessType: { en: 'What kind of place is it?', ar: 'ما نوع المكان؟' },
  businessTypeHint: { en: 'Picks the modules the café starts with and the add-ons ticked below. The owner can change any of them later in admin.', ar: 'يحدد الوحدات التي يبدأ بها المكان والإضافات المحددة بالأسفل. يمكن للمالك تغييرها لاحقًا من لوحة الإدارة.' },
  businessCoffeeShop: { en: 'Coffee shop', ar: 'كافيه' },
  businessCoffeeShopAbout: { en: 'Counter service, loyalty, a bar screen', ar: 'خدمة على الكاونتر، نقاط ولاء، شاشة للبار' },
  businessRestaurant: { en: 'Restaurant', ar: 'مطعم' },
  businessRestaurantAbout: { en: 'Tables, bookings, a kitchen', ar: 'طاولات، حجوزات، مطبخ' },
  businessGameStation: { en: 'Game station', ar: 'جيم ستيشن' },
  businessGameStationAbout: { en: 'Rooms by the hour, bookings, snacks', ar: 'غرف بالساعة، حجوزات، سناكس' },
  businessOther: { en: 'Something else', ar: 'نوع آخر' },
  businessOtherAbout: { en: 'Everything the plan allows, on', ar: 'كل ما تسمح به الباقة مفعّل' },
  arabicStyle: { en: 'Arabic', ar: 'العربية' },
  arabicStandard: { en: 'Standard', ar: 'الفصحى' },
  arabicEgyptian: { en: 'Egyptian', ar: 'المصرية' },
  arabicStyleHint: { en: "Which Arabic the café's apps speak to staff and customers.", ar: 'أي لهجة عربية تستخدمها تطبيقات المكان مع الموظفين والعملاء.' },
  defaultTheme: { en: 'Starting theme', ar: 'المظهر الافتراضي' },
  defaultThemeHint: { en: 'What a new customer or device starts in, until they choose their own.', ar: 'المظهر الذي يبدأ به العميل أو الجهاز الجديد حتى يختار بنفسه.' },
  ...
  tabTeam: { en: 'Team', ar: 'الفريق' },

  // Your account (Keycloak's own pages)
  changePassword: { en: 'Change password', ar: 'غيّر كلمة السر' },
  securitySettings: { en: 'Authenticator & sessions', ar: 'تطبيق التحقق والجلسات' },

  // Team: the people who run the platform
  teamNote: { en: 'Everyone here can sign in to the control app. Each sets their own password and an authenticator app on first sign-in.', ar: 'كل اللي هنا يقدر يدخل على لوحة التحكم. كل واحد بيحط كلمة السر بتاعته وتطبيق تحقق أول ما يدخل.' },
  inviteOperator: { en: 'Invite operator', ar: 'ضيف مشغّل' },
  noOperators: { en: 'Nobody here yet', ar: 'مفيش حد لسه' },
  email: { en: 'Email', ar: 'الإيميل' },
  firstName: { en: 'First name', ar: 'الاسم الأول' },
  lastName: { en: 'Last name', ar: 'اسم العيلة' },
  added: { en: 'Added', ar: 'اتضاف' },
  you: { en: 'You', ar: 'إنت' },
  operatorActive: { en: 'Active', ar: 'شغّال' },
  operatorDisabled: { en: 'Disabled', ar: 'متوقف' },
  operatorPendingSetup: { en: 'Setup pending', ar: 'مستني الإعداد' },
  operatorTwoFactor: { en: 'Authenticator on', ar: 'التحقق شغّال' },
  operatorNoTwoFactor: { en: 'No authenticator', ar: 'من غير تحقق' },
  operatorActions: { en: 'Actions for {email}', ar: 'إجراءات {email}' },
  resetPassword: { en: 'Reset password', ar: 'كلمة سر جديدة' },
  resetAuthenticator: { en: 'Reset authenticator', ar: 'امسح تطبيق التحقق' },
  signOutEverywhere: { en: 'Sign out everywhere', ar: 'اخرج من كل الأجهزة' },
  disableOperator: { en: 'Disable', ar: 'وقّف' },
  enableOperator: { en: 'Enable', ar: 'شغّل' },
  inviteNote: { en: 'They get a temporary password to sign in with; Keycloak then asks them for their own and for an authenticator app.', ar: 'هياخد كلمة سر مؤقتة يدخل بيها؛ وبعدين Keycloak هيطلب منه كلمة سر بتاعته وتطبيق تحقق.' },
  invite: { en: 'Invite', ar: 'ضيف' },
  operatorInvited: { en: '{email} can sign in now', ar: '{email} يقدر يدخل دلوقتي' },
  temporaryPassword: { en: 'Temporary password', ar: 'كلمة سر مؤقتة' },
  signInAt: { en: 'Sign in at', ar: 'يدخل من' },
  shownOnce: { en: 'This password is shown once. Hand it over in person or over a channel you trust; it works only until they choose their own.', ar: 'كلمة السر دي بتظهر مرة واحدة بس. سلّمها بنفسك أو على حاجة إنت واثق فيها؛ بتشتغل لحد ما يختار كلمة سر بتاعته.' },
  passwordResetFor: { en: 'New password for {email}', ar: 'كلمة سر جديدة لـ {email}' },
  resetPasswordTitle: { en: 'Reset the password of {email}?', ar: 'نعمل كلمة سر جديدة لـ {email}؟' },
  resetPasswordNote: { en: 'Their current password stops working and every session they have ends. You get a temporary one to hand over.', ar: 'كلمة السر الحالية هتبطل وكل جلساته هتقفل. هتاخد كلمة سر مؤقتة تسلّمها له.' },
  resetAuthenticatorTitle: { en: 'Reset the authenticator of {email}?', ar: 'نمسح تطبيق التحقق بتاع {email}؟' },
  resetAuthenticatorNote: { en: 'For a lost or replaced phone: the old app stops working, their sessions end, and they set up a new one on the next sign-in.', ar: 'لو الموبايل ضاع أو اتغيّر: التطبيق القديم هيبطل، جلساته هتقفل، وهيظبط واحد جديد أول ما يدخل.' },
  disableOperatorTitle: { en: 'Disable {email}?', ar: 'نوقّف {email}؟' },
  disableOperatorNote: { en: 'They are signed out everywhere and cannot sign in until someone enables them again.', ar: 'هيخرج من كل الأجهزة ومش هيقدر يدخل لحد ما حد يشغّله تاني.' },
  operatorSignedOut: { en: '{email} was signed out everywhere', ar: '{email} خرج من كل الأجهزة' },
  authenticatorReset: { en: '{email} sets up a new authenticator on the next sign-in', ar: '{email} هيظبط تطبيق تحقق جديد أول ما يدخل' },
  operatorDisabledToast: { en: '{email} is disabled', ar: '{email} اتوقف' },
  operatorEnabledToast: { en: '{email} can sign in again', ar: '{email} يقدر يدخل تاني' },
