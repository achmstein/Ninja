 ...
 */
export const simulateOnlinePayment = <ThrowOnError extends boolean = false>(options: Options<SimulateOnlinePaymentData, ThrowOnError>): RequestResult<SimulateOnlinePaymentResponses, SimulateOnlinePaymentErrors, ThrowOnError> => (options.client ?? client).post<SimulateOnlinePaymentResponses, SimulateOnlinePaymentErrors, ThrowOnError>({
    responseType: 'json',
 ...
 */
export const cancelOnlinePayment = <ThrowOnError extends boolean = false>(options: Options<CancelOnlinePaymentData, ThrowOnError>): RequestResult<CancelOnlinePaymentResponses, CancelOnlinePaymentErrors, ThrowOnError> => (options.client ?? client).post<CancelOnlinePaymentResponses, CancelOnlinePaymentErrors, ThrowOnError>({ url: '/api/sales/payments/{key}/cancel', ...options });
