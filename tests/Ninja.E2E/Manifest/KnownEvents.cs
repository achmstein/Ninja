...
/// (tests/Ninja.Contracts.Tests) check the publisher/consumer wiring itself.
/// </summary>
public static class KnownEvents
{
    ...
    [
        ...
        new("TenantFeaturesChanged", "Tenant", ["Spaces", "Sales"]),
        ...
        new("TicketVoided", "Sales", ["Loyalty", "Notification"]),
