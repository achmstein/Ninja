 ...
 */
export const forgetTenant = <ThrowOnError extends boolean = false>(options: Options<ForgetTenantData, ThrowOnError>): RequestResult<ForgetTenantResponses, ForgetTenantErrors, ThrowOnError> => (options.client ?? client).delete<ForgetTenantResponses, ForgetTenantErrors, ThrowOnError>({ url: '/api/control/tenants/{slug}/record', ...options });
...
/**
 * Each lane's running job and queue depth, and the latest jobs
 */
export const getPlatformJobs = <ThrowOnError extends boolean = false>(options?: Options<GetPlatformJobsData, ThrowOnError>): RequestResult<GetPlatformJobsResponses, GetPlatformJobsErrors, ThrowOnError> => (options?.client ?? client).get<GetPlatformJobsResponses, GetPlatformJobsErrors, ThrowOnError>({
    responseType: 'json',
