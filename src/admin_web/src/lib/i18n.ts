...
const webExtras = {
  ...
  appsDescription: {
    en: 'The till and the kitchen display for Android tablets. One app for every café: install it, then connect it to yours with the code below.',
    ar: 'الكاشير وشاشة المطبخ لتابلت أندرويد. تطبيق واحد لكل الكافيهات: ثبّته، وبعدين وصّله بكافيهك بالكود اللي تحت.',
  },
  appsPosTitle: { en: 'ninja POS', ar: 'ninja POS' },
  appsPosAbout: {
    en: 'The till: the floor, tickets, payments and shifts, on a landscape tablet by the counter.',
    ar: 'الكاشير: الصالة، التذاكر، الدفع والشيفتات، على تابلت عرضي جنب الكاونتر.',
  },
  appsKdsTitle: { en: 'ninja KDS', ar: 'ninja KDS' },
  appsKdsAbout: {
    en: 'The kitchen display: every order as it comes in, bumped when it is done.',
    ar: 'شاشة المطبخ: كل أوردر أول ما يوصل، ويتشال لما يخلص.',
  },
  appsDownloadAndroid: { en: 'Download for Android', ar: 'تحميل لأندرويد' },
  appsNotPublishedHere: { en: 'Downloads are not published in this environment', ar: 'التحميل مش متاح في البيئة دي' },
  appsOpenWeb: { en: 'Open the web version', ar: 'افتح نسخة الويب' },
  appsConnectTitle: { en: 'Connect a tablet', ar: 'وصّل تابلت' },
  appsConnectHint: {
    en: 'When the app first opens it asks which café it belongs to. Scan this code from the app, or type the address.',
    ar: 'أول ما التطبيق يفتح بيسأل تابع أنهي كافيه. امسح الكود ده من التطبيق، أو اكتب العنوان.',
  },
  appsAddressCopied: { en: 'Address copied', ar: 'اتنسخ العنوان' },
  appsIosHint: {
    en: 'iPhones and iPads use the web version, added to the home screen.',
    ar: 'الآيفون والآيباد بيستخدموا نسخة الويب، مضافة للشاشة الرئيسية.',
  },
  copy: { en: 'Copy', ar: 'نسخ' },
  ...
  takesReservations: { en: 'Takes reservations', ar: 'بتتحجز' },
  takesReservationsHint: {
    en: 'Customers can reserve it from the app, with or without a clock',
    ar: 'العميل يقدر يحجزها من التطبيق، بالوقت أو من غيره',
  },
  ...
  noReservationHistory: {
    en: 'No reservations for this range.',
    ar: 'مفيش حجوزات في الفترة دي.',
  },
  noReservationsYet: { en: 'No reservations yet', ar: 'مفيش حجوزات لسه' },
  reservedFor: { en: 'For', ar: 'ميعاد الحجز' },
  madeAt: { en: 'Made', ar: 'اتعمل' },
