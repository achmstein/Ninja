...
/// </summary>
public static class ChillaxAIRateLimiting
{
    public const string PolicyName = "ai-assist";

    private static readonly TimeSpan Window = TimeSpan.FromMinutes(1);

    public static IServiceCollection AddChillaxAIRateLimiting(this IServiceCollection services, int requestsPerMinute, int perUserRequestsPerMinute)
    {
